...
define('VIRTUAL_PATH', 'http://fishersergent.com/retro/'); # Virtual (web) 'root' of application for images, JS & CSS files

define('PHYSICAL_PATH', '/home/elifis5/fishersergent.com/retro/'); # Physical (PHP) 'root' of application for file & upload reference
...
switch(THIS_PAGE)
{
    case 'template.php':
        ...
        break;
         ...
         case 'artpieces_list.php':
        $title = 'title tag for the Art Pieces page';
        $pageID = 'Art';
        break;
...
function makeLinks($arr,$prefix='',$suffix='',$exception='')
{
    ...
    {
        if(THIS_PAGE == $link)//current page
        {
